...
{
    cpu->m_cr.raw = 0xA5000000; // cr0 occupies bits [31:28]
...
{
    cpu->m_cr.raw = 0;
    cpu->m_cr.cr0 = Core::ConditionRegisterFlag::Negative;
    ...
    // cr0 is the HIGH nibble, Negative (0x8) → bits [31:28] → 0x80000000
