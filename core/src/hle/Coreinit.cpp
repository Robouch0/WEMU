...
static void hle_OSGetTime(Core::Interpreter& cpu)             { cpu.m_gpr[3] = 0; cpu.m_gpr[4] = 0; }
static void hle_OSGetTitleID(Core::Interpreter& cpu)          { cpu.m_gpr[3] = 0; cpu.m_gpr[4] = 0; }
...
static void hle_OSIsDebuggerInitialized(Core::Interpreter& cpu){ Utils::Log::error("hle_OSIsDebuggerInitialized"); cpu.m_gpr[3] = 0; }
...
static void hle_MEMAllocFromDefaultHeap(Core::Interpreter& cpu)
{
    cpu.m_gpr[3] = cpu.m_memory.heapAllocate(cpu.m_gpr[3], 8);
}
