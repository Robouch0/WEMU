...
TEST_F(InstructionTest, DIVWU_NoOe_NoRc_IntegerResult)
{
    cpu->m_gpr[3] = 10;
    cpu->m_gpr[4] = 2;
...
TEST_F(InstructionTest, DIVWU_NoOe_NoRc_FloatResult)
{
    cpu->m_gpr[3] = 9;
    cpu->m_gpr[4] = 2;
...
TEST_F(InstructionTest, DIVWU_NoOe_WithRc_Greater)
{
    cpu->m_gpr[3] = 10;
    cpu->m_gpr[4] = 2;
...
TEST_F(InstructionTest, DIVWU_WithOe_NoRc_NoError)
{
    cpu->m_gpr[3] = 50;
    cpu->m_gpr[4] = 2;
...
TEST_F(InstructionTest, DIVWU_WithOe_NoRc_ImpossibleDivisionByZero)
{
    cpu->m_gpr[3] = 67;
    cpu->m_gpr[4] = 0;
...
TEST_F(InstructionTest, DIVWU_WithOe_WithRc_NoError)
{
    cpu->m_gpr[3] = 67;
    cpu->m_gpr[4] = 2;
