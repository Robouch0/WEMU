...
TEST_F(InstructionTest, MTCRF_OnlyCR0_FXM0x80)
{
    ...
    EXPECT_EQ(((cpu->m_cr.cr0 & Core::ConditionRegisterFlag::SummaryOverflow) ? 1 : 0), 1u);
    // CR1-CR7 must stay 0
...
TEST_F(InstructionTest, MTCRF_OnlyCR7_FXM0x01)
{
    ...
    EXPECT_EQ(((cpu->m_cr.cr7 & Core::ConditionRegisterFlag::Negative) ? 1 : 0), 1u);
    EXPECT_EQ(((cpu->m_cr.cr7 & Core::ConditionRegisterFlag::Positive) ? 1 : 0), 1u);
    EXPECT_EQ(((cpu->m_cr.cr7 & Core::ConditionRegisterFlag::Zero) ? 1 : 0), 1u);
    EXPECT_EQ(((cpu->m_cr.cr7 & Core::ConditionRegisterFlag::SummaryOverflow) ? 1 : 0), 1u);
    // CR0-CR6 must stay 0
